...
const en = {
  ...
  eyebrow: 'PURE PARTS TECHNOLOGY PLATFORM',
...
const de = {
  ...en,
  breadcrumb: 'Pure Liquid Heat', eyebrow: 'PURE PARTS TECHNOLOGY PLATFORM', heroTitle: 'PURE LIQUID HEAT', heroSubtitle: 'Eine elektrisch aktivierbare Funktionsschicht für integrierte Heizsysteme.', heroCopy: 'Heizen wird zur Oberflächenfunktion – integriert in definierte Platten, Produkte und Designobjekte, statt als separates Heizgerät ergänzt zu werden.', explore: 'Anwendungen entdecken', evidenceCta: 'Technische Nachweise', conceptCaption: 'Anwendungsrichtung Hospitality – Entwicklungskonzept.',
