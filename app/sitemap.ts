...
export default function sitemap(): MetadataRoute.Sitemap {
  const routes = [
    ...
    { de: '/de/produkte/pure-fire-protect', en: '/en/products/pure-fire-protect' },
    { de: '/de/produkte/pure-water-protect', en: '/en/products/pure-water-protect' },
    { de: '/de/produkte/pure-wood-protect', en: '/en/products/pure-wood-protect' },
    { de: '/de/produkte/pure-boat-protect', en: '/en/products/pure-boat-protect' },
    ...
    { de: '/de/nachweise', en: '/en/evidence' },
