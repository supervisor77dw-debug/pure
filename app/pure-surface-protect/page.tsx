...
export default function PureSurfaceProtectPage() {
  ...
  return <>
    ...
    <ProductHeroAmbient variant="surface" motionEnabled className="surface-protect-hero" poster="Taufrische Glasfassade im Abendlicht.png" posterAlt="Ruhige architektonische Oberfläche mit transparenter funktionaler Beschichtung">
