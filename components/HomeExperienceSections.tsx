...
const products = [
  { slug: 'pure-thermo', name: 'PURE THERMO', category: { de: 'Thermische Funktionsschicht', en: 'Thermal functional layer' }, copy: { de: 'Dünne Beschichtung für Bauteile, Details und begrenzte Aufbauhöhen.', en: 'Thin coating for components, details and limited build-up heights.' }, asset: { de: 'Architektonischer Wandschichtquerschnitt.png', en: 'Architektonischer Wandschichtquerschnitt.png' }, position: '42% 52%' },
  { slug: 'pure-liquid-heat', name: 'PURE LIQUID HEAT', category: { de: 'Elektrische Wärme', en: 'Electrical heat' }, copy: { de: 'Flächige elektrische Wärme als Material- und Modulroute.', en: 'Surface electrical heat as material and module route.' }, asset: { de: 'LH_CONCEPT_PureHeat_Prism_01.jpg', en: 'LH_CONCEPT_PureHeat_Prism_01.jpg' }, position: 'center' },
  { slug: 'pure-floor-protect', name: 'PURE FLOOR PROTECT', category: { de: 'Bodenoberflächen', en: 'Floor surfaces' }, copy: { de: 'Oberflächenschutz für stark genutzte Bodenbereiche.', en: 'Surface protection for heavily used floor areas.' }, asset: { de: 'Cinematic Bodennaht mit Wassertropfen.png', en: 'Cinematic Bodennaht mit Wassertropfen.png' }, position: '58% 58%' },
  { slug: 'pure-fire-protect', name: 'PURE FIRE PROTECT', category: { de: 'Brandschutz', en: 'Fire protection' }, copy: { de: 'Brandschutzroute mit klarer Prüf- und Klassifizierungslogik.', en: 'Fire-protection route with clear testing and classification logic.' }, asset: { de: '01_fire_hero_wood_architecture.jpeg', en: '01_fire_hero_wood_architecture.jpeg' }, position: 'center' },
  { slug: 'pure-surface-protect', name: 'PURE SURFACE PROTECT', category: { de: 'Oberflächenschutz', en: 'Surface protection' }, copy: { de: 'Schutzprinzip für Architektur-, Infrastruktur- und Industrieoberflächen.', en: 'Protection principle for architecture, infrastructure and industrial surfaces.' }, asset: { de: 'transluzente Beschichtung auf rauem Beton.png', en: 'transluzente Beschichtung auf rauem Beton.png' }, position: '58% 52%' },
  { slug: 'pure-water-protect', name: 'PURE WATER PROTECT', category: { de: 'Unterwasser / Marine', en: 'Underwater / marine' }, copy: { de: 'Easy-to-clean-Route für maritime und dauerhaft wasserberührte Oberflächen.', en: 'Easy-to-clean route for marine and water-exposed surfaces.' }, asset: { de: 'Unterwasserblick auf einen bewachsenen Bootsrumpf.png', en: 'Unterwasserblick auf einen bewachsenen Bootsrumpf.png' }, position: 'center' },
  { slug: 'pure-wood-protect', name: 'PURE WOOD PROTECT', category: { de: 'Holzoberflächen', en: 'Wood surfaces' }, copy: { de: 'Schutzroute für Holzbauteile und sichtbare Holzoberflächen.', en: 'Protection route for timber components and visible wood surfaces.' }, asset: { de: 'Verwitterte Holzfassade im Abendlicht.png', en: 'Verwitterte Holzfassade im Abendlicht.png' }, position: 'center' },
  { slug: 'pure-boat-protect', name: 'PURE BOAT PROTECT', category: { de: 'Yacht & Boot', en: 'Yacht & boat' }, copy: { de: 'Oberflächenroute für Yacht- und Bootsbereiche.', en: 'Surface route for yacht and boat areas.' }, asset: { de: 'Luxusyacht im goldenen Hafenlicht.png', en: 'Luxusyacht im goldenen Hafenlicht.png' }, position: 'center' }
] as const;
