...
const products = [
  ...
  { slug: 'pure-water-protect', name: 'PURE WATER PROTECT', category: { de: 'Unterwasser / Marine', en: 'Underwater / marine' }, copy: { de: 'Easy-to-clean-Route für maritime und dauerhaft wasserberührte Oberflächen.', en: 'Easy-to-clean route for marine and water-exposed surfaces.' }, asset: { de: 'Unterwasserblick auf einen bewachsenen Bootsrumpf.png', en: 'Unterwasserblick auf einen bewachsenen Bootsrumpf.png' } },
  { slug: 'pure-wood-protect', name: 'PURE WOOD PROTECT', category: { de: 'Holzoberflächen', en: 'Wood surfaces' }, copy: { de: 'Schutzroute für Holzbauteile und sichtbare Holzoberflächen.', en: 'Protection route for timber components and visible wood surfaces.' }, asset: { de: 'Verwitterte Holzfassade im Abendlicht.png', en: 'Verwitterte Holzfassade im Abendlicht.png' } },
  { slug: 'pure-boat-protect', name: 'PURE BOAT PROTECT', category: { de: 'Yacht & Boot', en: 'Yacht & boat' }, copy: { de: 'Oberflächenroute für Yacht- und Bootsbereiche.', en: 'Surface route for yacht and boat areas.' }, asset: { de: 'Luxusyacht im goldenen Hafenlicht.png', en: 'Luxusyacht im goldenen Hafenlicht.png' } }
] as const;
